namespace Assignment5
{
        ...
        
    {
        public SortedList<string, int> MulVectors(string[] Voters)
        {
            ...
            {
                int count = 0;
                if (MultipleVoters.ContainsKey(name))  //chech if the mulitple voters list already contains the name and count
                {
                    continue;
                }
        ...
        {
            string[] Voters = { "Alexa", "Seyi", "Pius", "Yusuf","Alexa", "Nas", "Nas", "Ama", "Yusuf", "Alexa", "Tosin" };
